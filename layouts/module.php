...
// types available: raw, box, dropdown, default-1 
// check /warp/layouts/modules/templates/ to add custom style markup 

if ($style == '') {
	if ($module->position == 'footer') $style = 'box';
	if ($module->position == 'grid') $style = 'box';
}
...
// force module style
if (in_array($module->position, array('absolute', 'breadcrumbs', 'search'))) {
	$style = 'raw';
	$showtitle = 0;
}
